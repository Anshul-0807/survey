...
# ⚙️  CONFIG
# ─────────────────────────────────────────────────────────
SAMBANOVA_API_KEY = "f8fe9346-b809-47a5-a82d-84e8e4348c6a"
HEADLESS          = False
SLOW_MO           = 400
TIMEOUT           = 45000
...
def find_captcha_input(page):
    ...
    try:
        el = page.locator("input[placeholder='कैप्चा दर्ज करें']").first
        if el.is_visible(timeout=1500):
            return el
    except Exception:
        pass
        ...
        if khasra_no:
            ...
            for attempt in range(1, MAX_CAPTCHA_RETRY + 1):
                ...
                try:
                    ...
                    clicked = click_button_by_text(page, ["Search", "खोजें", "खोज", "Submit"])
                    if not clicked:
